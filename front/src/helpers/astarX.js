...
const gridW = gridX.length;
const gridH = gridY.length;
...
const toFlat = (gridIndexes) => gridIndexes[1] * gridW + gridIndexes[0];
const toGrid = (flatIndex) => [flatIndex % gridW, (flatIndex / gridW) | 0];
...
const fieldBounds = [0, 0, gridW - 1, gridH - 1];
...
const doAStar = (startIndex, goalIndex) => {
    ...
    const cameFrom = new Array(gridW * gridH).fill(null);
